...
public class PluginsService implements EnvironmentAware {
  ...
  private void initPlugins() {
    ...
    String pluginName = environment.getProperty("plugins." + MICA_SEARCH_PLUGIN_NAME, DEFAULT_MICA_SEARCH_PLUGIN_NAME);
  ...
  private void initSearchEngineServicePlugin(PluginResources plugin) {
    ...
    for (String key : ES_CONFIGURATION) {
      if (environment.containsProperty("elasticsearch." + key))
        properties.setProperty(key, environment.getProperty("elasticsearch." + key));
    }
